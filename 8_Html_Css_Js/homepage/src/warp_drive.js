$( document ).ready( function() {
  ...
  var canvasWidth = widthInPixels * 2;
  var canvasHeight = heightInPixels * 2.5;
  ...
  document.getElementById( 'box-warp-drive' ).appendChild( canvas );
  ...
  var starSpeedMax = 130;
  var starDistance = 13000;
  var starRotation = 0;
